...
from RFS.comm_type.srvs import ServiceRequestType, ServiceType

from RFS.RFS_SocketType import RFS_Socket_Request_RegisterServiceClient, RFS_Socket_Request_RegisterServiceServer, RFS_Socket_Request_ServiceRequest, RFS_Socket_Request_ServiceResponse, RFS_Socket_RequestContent_Register, RFS_Socket_RequestFrom, RFS_Socket_RequestType
from RFS.comm_type.msgs import MessageType
from RFS.comm_obj.CommObj import CommObj
    ...
    def register_to_core(self):
        ...
        self.client_to_core_socket.send(
            RFS_Socket_Request_RegisterServiceServer(
                request_name=self.service_name,
                request_id=RFS.generate_random_id(),
                request_content=RFS_Socket_RequestContent_Register(
                    server_socket_host=self.host,
                    server_socket_port=self.port
                ),
