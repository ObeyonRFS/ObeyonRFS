...
import RFS
from RFS.RFS_Socket import RFS_CoreServerSocket, RFS_CoreToCommObjClientSocket
from RFS.RFS_SocketType import *
...
def start_core():
    ...
    print(f"Core is started at {RFS.get_core_host()}:{RFS.get_core_port()}...")
